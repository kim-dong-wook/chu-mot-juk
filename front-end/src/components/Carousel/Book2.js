  ...
  return (
    <div className="px-[5%] pt-10">
      ...
      <Swiper
        ...
        // width={1100}
      >
        <SwiperSlide className="aa w-60 h-[20.5rem] items-center flex justify-center hover:bg-sky-700 hover:scale-125 duration-300 origin-left hover:z-50">
          <img src="https://img.ridicdn.net/cover/4621001638/xxlarge#1"></img>
        </SwiperSlide>
        <SwiperSlide className="aa w-60 h-[20.5rem] items-center flex justify-center hover:bg-sky-700 hover:scale-125 duration-300 hover:z-50">
        ...
        <SwiperSlide className="aa w-60 h-[20.5rem] items-center flex justify-center hover:bg-sky-700 hover:scale-125 duration-300 origin-right hover:z-50">
